...
async function controlRecipes() {
    try {
        ...
        // 1 load
        await _modelJs.loadTestData(id);
        // 2 render
...
async function controlSearchResults() {
    try {
        ...
        if (!query) return;
        await _modelJs.loadSearchReults(query);
...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const loadTestData = async function(id) {
    try {
        const data = await (0, _helpers.getJSON)(`${(0, _config.API_URL)}/get?rId=${id}`);
...
const loadSearchReults = async function(query) {
    try {
        ...
        const data = await (0, _helpers.getJSON)(`${(0, _config.API_URL)}/search?q=${query}`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../config":"jtCLN","./helpers":"hGI1E"}],"gkKU3":[function(require,module,exports) {
...
},{"../config":"jtCLN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l60JC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addHandlerRender(handler) {
        [
            "load",
            "hashchange"
        ].forEach((eventType)=>window.addEventListener(eventType, handler));
    }
    generateMarkup() {
        return `
...
},{"./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire4572")
